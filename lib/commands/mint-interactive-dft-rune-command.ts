...
export class MintInteractiveDftRuneCommand implements CommandInterface {
  constructor(
  ...
  async run(): Promise<any> {
    ...
    logBanner('Mint Interactive FT (Decentralized) and runes');
    console.log("Atomical type:", 'FUNGIBLE (decentralized)', filesData, this.ticker);
    console.log("Mint for ticker: ", this.ticker, "runeid ", this.blockNumber, ":", this.txNumber);
